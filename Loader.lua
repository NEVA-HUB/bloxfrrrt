...
if World3 then
Main:Seperator("Farm Heart")
Main:Toggle("Auto Farm Heart",_G.Auto_Farm_Heart,function(value)
 _G.Auto_Farm_Heart = value
 StopTween(_G.Auto_Farm_Heart)
 end)
...
spawn(function()
 game:GetService("RunService").Heartbeat:Connect(function()
  pcall(function()
   for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
   if _G.Auto_Farm_Heart and StartMagnetHeartMon and (v.Name == "Candy Pirate [Lv. 2400]" or v.Name == "Snow Demon [Lv. 2425]") and (v.HumanoidRootPart.Position - PosMonFishTail.Position).magnitude <= 350 then
...
spawn(function()
 while wait() do
 if _G.Auto_Farm_Heart and World3 then
 pcall(function()
...
game:GetService("VirtualUser"):CaptureController()
 game:GetService("VirtualUser"):Button1Down(Vector2.new(1280 , 670),workspace.CurrentCamera.CFrame)
 sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius",  math.huge)
  until _G.Auto_Farm_Heart == false or not v.Parent or v.Humanoid.Health <= 0
  end
  end
  end
  else
   StartMagnetHeartMon = false
  for i,v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
  ...
  toTarget(CFrame.new(-1052.479736328125, 14.833312034606934, -14221.18359375))
  end
  end)
 end
 end
...
Main:Button("Redeem All Code",function()
 ...
 Main:Button("Mink Fake Transform",function()
     require(game:GetService("ReplicatedStorage").Notification).new("Mink V4! / By : NEVA HUB"):Display();
     wait()
     setthreadcontext(5)
     ...
     require(game:GetService("ReplicatedStorage").Notification).new("Fishman V4! / By : Neva Hub "):Display();
     wait()
     setthreadcontext(5)
     ...
     require(game:GetService("ReplicatedStorage").Notification).new("Skypeian V4! / By : Neva Hub"):Display();
     wait()
     setthreadcontext(5)
     ...
     require(game:GetService("ReplicatedStorage").Notification).new("Ghoul V4! / By : Neva Hub"):Display();
     wait()
     setthreadcontext(5)
     ...
     require(game:GetService("ReplicatedStorage").Notification).new("Cyborg V4! / By : Neva Hub"):Display();
     wait()
     setthreadcontext(5)
     ...
     require(game:GetService("ReplicatedStorage").Notification).new("Human V4! / By : Neva Hub"):Display();
     wait()
     setthreadcontext(5)
					...
					if game.Players.LocalPlayer.Backpack:FindFirstChild("God's Chalice") or game.Players.LocalPlayer.Character:FindFirstChild("God's Chalice") then
						if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SweetChaliceNpc"),"Where") then
							game.StarterGui:SetCore("SendNotification", {
								...
								Icon = "http://www.roblox.com/asset/?id=12258186601",
								Duration = 2.5
							})
						else
...
Setting:Dropdown("Select Farm Method",{"Behind","Below","Upper"},function(value)
    ...
    _G.DistanceMob = 20
    Setting:Slider("Farm Distance",1,100,30,function(value)
...
spawn(function()
  ...
  Setting:Toggle("Remove Attack",false,function(value)
...
Setting:Toggle("Bring Mob [Ultra]",false,function(value)
 _G.BringExtra = value
end)
...
Teleport:Seperator("WORLD")
 ...
 Teleport:Toggle("Teleport",false,function(value)
  ...
  toTarget(CFrame.new(-1101.261962890625, 22.777254104614258, -14790.025390625))
  end
...
if World2 then
		Dungeon:Button("TP Flower Red",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
		...
		Dungeon:Button("TP Flower Blue",function()
			for i,v in pairs(game.Workspace:GetDescendants()) do
	...
	Dungeon:Toggle("ESP Player",false,function(a)
		ESPPlayer = a
		while ESPPlayer do wait()
			UpdatePlayerChams()
		end
	end)
	Dungeon:Toggle("ESP Chest",false,function(a)
		ChestESP = a
		while ChestESP do wait()
			UpdateChestChams() 
		end
	end)
	Dungeon:Toggle("ESP Devil Fruit",false,function(a)
		DevilFruitESP = a
		while DevilFruitESP do wait()
			UpdateDevilChams() 
		end
	end)
	Dungeon:Toggle("ESP Flower",false,function(a)
		FlowerESP = a
